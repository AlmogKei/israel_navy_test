...
const Tasks = () => {
  ...
  const fetchTasks = async () => {
    try {
      const response = await fetch(`https://israel-navy-server.onrender.com/users/tasks/${userId}`);
  ...
  const handleSaveEdit = async (taskId) => {
    try {
      const response = await fetch(`https://israel-navy-server.onrender.com/users/tasks/${taskId}`, {
        method: 'PUT',
  ...
  const handleAddTask = async () => {
    try {
      ...
      const response = await fetch('https://israel-navy-server.onrender.com/users/tasks', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          ...newTask,
